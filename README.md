...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
   React js was developed by facebook and created to make interactive pieces of state, capsules, modules, the like. It allows for distrubition of work flow and

1. Describe component state.
   Component state holds informaion about a page the can change. This state can change by rerendering the page

1. Describe props.
   props are arguments within each function

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
   Side effect are things that happen outside the scope of the current function being excuted. They can look like clicks being copied becuase we didn't remove them after the state changed, or extra un needed calls to the API
